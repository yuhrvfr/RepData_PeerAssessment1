...
Weekend actity is more spread across all intervals, there are more activities in the afternoon in comparison to the weekdays. The weekday has pick of activities around the interval 835. By adding the linear regression line, we can see the weekend activity level is slidly higher than weekday.